...
export class CardDetalleComponent implements OnInit {
  ...
  cargarCarrito(): void {
    if (this.userId) { // Verifica que userId no sea null o undefined
      this.listaCarrito = this._localStorageService.getCarrito(this.userId);
    } else {
      console.error('User ID es null o undefined. No se puede cargar el carrito.');
  ...
  agregarAlCarrito(productoId: number, cantidad: number): void {
    ...
    if (this.userId) {
      ...
      this._localStorageService.agregarAlCarrito(this.userId, productoId, cantidad);
  ...
  eliminarProducto(productoId: number): void {
    if (this.userId) { // Verifica que userId no sea null o undefined
      ...
      console.error('User ID es null o undefined. No se puede eliminar el producto.');
      // Aquí puedes manejar el caso en el que no hay un usuario autenticado
    }
  }
